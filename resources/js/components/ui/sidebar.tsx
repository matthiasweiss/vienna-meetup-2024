...
function SidebarGroupContent({ className, ...props }: React.ComponentProps) {
    return (
        <div
...
function SidebarMenuBadge({ className, ...props }: React.ComponentProps) {
    return (
        <div
...
function SidebarMenuSubItem({ className, ...props }: React.ComponentProps) {
    return (
        <li
